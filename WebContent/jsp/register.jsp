...
<head>
    ...
    <title>Register - CivicWatch</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .visual-panel::before {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(170deg, rgba(11, 21, 35, 0.1) 0%, rgba(11, 21, 35, 0.52) 100%);
            z-index: 1;
        }
        .visual-panel::after {
            content: '';
            ...
            height: 100%;
            width: 40%;
            background: linear-gradient(to right, rgba(11, 21, 35, 0) 0%, rgba(11, 21, 35, 0.34) 62%, rgba(248, 250, 252, 0.98) 100%);
            z-index: 2;
            pointer-events: none;
        }
        .visual-copy {
    ...
    <div class="auth-shell">
        <section class="visual-panel">
            ...
            <div class="visual-copy">
                ...
                <h1>Turn observations into action.</h1>
                <p>Create your account and start reporting infrastructure issues with clear, trackable progress.</p>
            </div>
        </section>
        ...
        <section class="form-panel">
            ...
            <div class="heading">
                <h2>Sign Up</h2>
                <p>Create an account to submit and follow community reports.</p>
            </div>
            ...
            <form action="<%= request.getContextPath() %>/auth" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="username" name="username" required pattern="[A-Za-z0-9_-]{3,50}" title="3-50 characters, letters, numbers, underscore">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="fullName" name="fullName" required minlength="2" maxlength="100" placeholder="Your full name">
                </div>

                <div class="form-row">
                    <div class="form-group">
                        <label for="password">Password</label>
                        <input type="password" id="password" name="password" required minlength="6" maxlength="50" placeholder="Min 6 chars">
                    </div>
                    <div class="form-group">
                        <label for="confirmPassword">Confirm Password</label>
                        <input type="password" id="confirmPassword" name="confirmPassword" required minlength="6" maxlength="50" placeholder="Repeat password">
                    </div>
                </div>
